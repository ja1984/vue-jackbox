(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-jackbox"] = factory();
	else
		root["vue-jackbox"] = factory();
...
var createModal = function createModal(props) {
  ...
  if (addFooter) {
    ...
    if (props.cancelCallback) {
      cancelButton.addEventListener('click', props.cancelCallback, {
        once: true
      });
    }
    ...
    if (cta.ctaCallback) {
      cta.addEventListener('click', props.ctaCallback, {
        once: true
      });
    }
  ...
  if (type === 'prompt') {
    ...
    input.value = props.inputValue, input.className = "jb-modal__input";
...
var VueJackBox = {
  install: function install(Vue) {
    Vue.prototype.$confirm = function (props) {
      ...
      var properties = _objectSpread2(_objectSpread2(_objectSpread2({}, defaultProps), props), {}, {
        type: 'confirm'
      });

      var jackbox = createModal(properties);
    ...
    Vue.prototype.$alert = function (props) {
      var documentBody = document.body;
      if (!documentBody) return;
      var jackbox = createModal(_objectSpread2(_objectSpread2(_objectSpread2({}, defaultProps), props), {}, {
        type: 'alert',
        centerButtons: true
      }));
      documentBody.appendChild(jackbox);
...
/* harmony default export */ var vue_jackbox = (VueJackBox);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (vue_jackbox);
...
//# sourceMappingURL=vue-jackbox.umd.js.map